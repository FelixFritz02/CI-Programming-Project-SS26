...
\begin{frame}{Das DRAUSP-Problem}
  ...
  \bigskip
  \textbf{Ziel:} Maximierung des \textbf{Gesamterlöses} unter Einhaltung der Kapazitätsschranken $C_k$.
...
\begin{frame}{Q-Learning -- Policy aus Q-Werten}
  ...
  \begin{block}{Q-Funktion}
    $Q(s, a)$ bewertet, wie gut es ist, in Zustand $s$ die Aktion $a$ zu wählen
    -- unter Berücksichtigung \textbf{aller zukünftigen Rewards}.
  \end{block}
...
\begin{frame}{Deep Q-Network (DQN)}
  ...
  \begin{block}{Warum ein neuronales Netz?}
    Der Zustandsraum ist zu groß, um $Q(s,a)$ tabellarisch zu speichern
    $\rightarrow$ ein \textbf{neuronales Netz} approximiert $Q(s,a)$ für alle Aktionen gleichzeitig.
  \end{block}

  \bigskip
  \textbf{Schlüsselideen des DQN:}
  \begin{itemize}
