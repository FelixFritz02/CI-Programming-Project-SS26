...
As a robustness check we additionally trained the Lattice-DQN for only $10\,000$ episodes
(instead of $20\,000$) on all instances. Averaged over all $51$ instances the shorter run is not
systematically worse: it outperforms the $20\,000$-episode run on $29$ of $51$ instances. The
effect is most pronounced on exactly the large-$T_d$ instances identified above as the
Lattice-DQN's weakest cases: SB05 improves from $7.77$ to $11.36$ ($62\%\to90\%$ of $Z^*$), WC03
from $1.60$ to $1.90$ ($75\%\to89\%$ of $Z^*$), and WA06 from $9.07$ to $9.84$ ($59\%\to64\%$ of
$Z^*$). This suggests that longer training does not monotonically improve the constrained
Lattice-DQN on the harder instances and can instead lead to overfitting or instability; some
easy instances (e.g.\ SA12, SA06, WA03) show the opposite effect and benefit from the additional
episodes, so the result is not a uniform recommendation to reduce training length but points to
Lattice-DQN training on hard instances not yet being fully stable.
