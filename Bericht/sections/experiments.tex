...
expected objective value $Z^*$ of the SDP formulation of \textcite{drausp_lion18} (their Table~2
and Table~1, respectively). $\bar R_{\text{eval}}$ is the mean cumulated reward over $10\,000$
...
runtime columns are wall-clock seconds for the $20\,000$ training episodes and the $10\,000$
...
\begin{table}[htbp]
  ...
  \caption{Results for the \texttt{lion18s} instances that require scheduling
...
\begin{table}[htbp]
  ...
  \footnotesize
  \setlength{\tabcolsep}{4pt}
  \caption{Results for the \texttt{W} instances (\texttt{lion18w}; blocks \texttt{WA} $K=4$,
