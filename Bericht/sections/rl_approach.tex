...
Figure~\ref{fig:state-transition} illustrates the effect of the transition function $\mathcal{T}$ for the capacities on a concrete example with
...
Once $Q^*$ is known (or
approximated by a trained network), the optimal policy follows acts greedily with
respect to it:
\[
