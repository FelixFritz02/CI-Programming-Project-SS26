...
Doing so, we constructed a monotonicity test to evaluate the learned $Q$-function (see Section~\ref{subsec:monotonicity-test}).\\
As a second approach, we took advantage of the known monotonicity relations presented in Section~\ref{subsec:monotonicity}
